		...
		if(isPressed){
			...
			for(int i = 0; i < Game.entities.size(); i++) {
				...
				if(e instanceof Player) {
					if(Entity.isColidding(e, player)) {
						liberado = false;
						System.out.println("N�o posso adicionar nesta posi��o pois j� existe uma torre!");
					}
				}
			}
			 ...
			 if(World.isFree(xx, yy)) {
				 liberado = false;
				 System.out.println("A posi��o que voc� deseja adicionar est� ocupada pelo mapa!");
			 }
			...
			if(liberado) {
				...
				Game.dinheiro-=20;
					...
					System.out.println("Voc� n�o possui dinheiro para construir torre!");
				}
			}
